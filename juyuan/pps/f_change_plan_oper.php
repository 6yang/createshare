...
$sql = "update schedule set studio_id = '$stu_id',play_id = '$play_id',
		sched_time = '$sch_time',sched_ticket_price = '$sch_price' where sched_id = '$sch_id'";
	mysqli_query($link, $sql);
	
mysqli_query($link, "delete from ticket where sched_id = '$sch_id'");
